...
def main() -> None:
    ...
    overlap_exact_train_step_ms = fp4_cached_fused_dx_cached_pack_overlap_exact_train_step_ms
    overlap_exact_grad_accum_total_ms = fp4_cached_fused_dx_cached_pack_overlap_exact_grad_accum_total_ms
    ...
    overlap_exact_grad_accum_per_micro_step_ms = overlap_exact_grad_accum_total_ms / args.grad_accum_steps
    ...
    payload = {
        ...
        "speedups": {
            ...
            "fp4_cached_fused_dx_cached_pack_overlap_exact_backward_estimate_vs_dense": (
                dense_train_step_ms - dense_forward_train_graph_ms
            )
            ...
            / fp4_cached_fused_dx_cached_pack_train_step_ms,
            "fused_dx_cached_pack_overlap_exact_vs_cached_pack_train_step": (
                fp4_cached_fused_dx_cached_pack_train_step_ms / overlap_exact_train_step_ms
            ),
            ...
            / fp4_cached_fused_dx_cached_pack_grad_accum_total_ms,
            "fused_dx_cached_pack_overlap_exact_vs_cached_pack_grad_accum": (
                fp4_cached_fused_dx_cached_pack_grad_accum_total_ms / overlap_exact_grad_accum_total_ms
            ),
